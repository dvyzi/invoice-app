...
export default function Invoice({ id, name, date, dateYear, total, status }) {
    return (
        <div className="flex items-center justify-between w-full bg-white rounded-lg p-6 lg:hover:cursor-pointer lg:hover:outline lg:hover:outline-primary-light lg:hover:outline-1">
